...
async def update_book(book_uid: uuid.UUID, book_update: BookUpdateModel, session: AsyncSession = Depends(get_session),user_details=Depends(access_token_bearer)):
